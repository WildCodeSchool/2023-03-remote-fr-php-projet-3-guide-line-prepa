...
class SoundFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    {
        $soundsDir = __DIR__ . '/../../public' . $this->parameterBag->get('sound_dir');
        if (!is_dir($soundsDir)) {
        ...
        foreach (self::SOUNDS as $soundArray) {
            ...
            $sound->setArtist($this->getReference($soundArray['author']));
            copy(
